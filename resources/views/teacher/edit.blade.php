                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6 l6">
                                    ...
                                    <input id="password" name="password" type="password"
                                        class="@error('password') error @enderror" placeholder="Leave empty if you don't want to change the password">
                                ...
                                <div class="input-field col s12 m6 l6">
                                    <select class="form-select" name="active" id="active">
                                        ...
                                        <option value="Y" {{ $Teacher->active == 'Y' ? ' selected' : '' }}>Active</option>
