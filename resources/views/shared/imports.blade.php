                    ...
                    {{-- <div class="alert">
                        <div class="row">
                            <div class="col l12 m12 s12 m-5">
                                <div class="success-alert-bar p-15 m-b-20 white-text">
                                    asdasdasd </div>
                            </div>
                        </div>
                    </div> --}}
                            ...
                            <div class="row">
                                <div class="col s12 l12">
                                    <form class="m-t-10"
                                        ...
                                        enctype="multipart/form-data" method="POST" id="import-groups">
                                        @csrf
                                        <div class="row">
                                            <div class="col s12">
                                                <h4>Import
                                                                ...
                                                                <ul>
                                                                    @if (session('Data.company_nature') == 'B')
                                                                        ...
                                                                        <li><b>'member_mobile_2'</b> : It is nullable,
                                                                            should be 12 digits only, must start with 923.
                                                                        </li>
                                                                        ...
                                                                        <li>
                                                                            <b>'active'</b> : It is required, must b 'Y',
                                                                            'N'
                                                                        </li>
                                                                    @else
                                                                        <li><b>'class_id'</b> : It is required, should be
                                                        ...
                                                        <ul class="collapsible">
                                                            <li>
                                                                ...
                                                                <div class="collapsible-body">
                                                                    ...
                                                                    <ul>
                                                                        <li><b>'class_id'</b> : It is required, should be
                                                                            numeric, should contain only 5 digits, should
                                                                            match
                                                                            with class code.</li>
                                                                        <li><b>'code'</b> : It is required, should be
        ...
        $('#import-groups').ajaxForm({
            ...
            complete: function(xhr) {
                ...
                $.each(xhr.responseJSON, function(k, v) {
                    console.log('k: ' + k + " v:" + v.row + " Error:" + v.errors[0]);
                    ErrorData+="File Row: "+v.row "\t Attribute: "
                });
