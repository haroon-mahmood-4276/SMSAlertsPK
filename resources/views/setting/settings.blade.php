                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s6 m3 l2 m-2">
                                            <a href="javascript:void(0)" id="subject_name"
                                                onmouseup="AttendanceTags(this.id)" class="chip">Subject Name</a>
                                        </div>
                                        @endif
                                        <div class="col s6 m3 l2 m-2">
                    ...
                    <div class="card-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m6 l6 m-t-30">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <form action="{{ route('r.settings-geo-location') }}" class="formValidate"
                                            id="geo_settings_form" method="POST">
                                            @csrf
                                            <div class="row">
                                                <div class="col s12 m12 l12">
                                                    <div class="row">
                                                            ...
                                                            <p>
                                                                <label>
                                                                    <input type="checkbox" id="geo_location_enabled"
                                                                        class="filled-in" name="geo_location_enabled"
                                                ...
                                                <div class="input-field col s12 m12 l6">
                                                    ...
                                                    <input id="latitude" onchange="initMap()" name="latitude"
                                                        type="number"
                                                        {{ $Setting->geo_location_enabled == 'Y' ? '' : 'disabled' }}
                                                        class="___class_+?96___" value="{{ $Setting->latitude}}"
                                                        step="any">
                                                ...
                                                <div class="input-field col s12 m12 l6">
                                                    ...
                                                    <input id="longitude" onchange="initMap()" name="longitude"
                                                        type="number"
                                                        {{ $Setting->geo_location_enabled == 'Y' ? '' : 'disabled' }}
                                                        class="___class_+?99___" value="{{ $Setting->longitude}}"
                                                        step="any">
