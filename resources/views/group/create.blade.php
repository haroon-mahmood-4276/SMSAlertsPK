                    ...
                    <form class="formValidate" id="formValidate" action="{{route('groups.store')}}" method="POST">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <input id="code" name="code" type="text" class="@error('code') error @enderror" value="{{old('code')}}" maxlength="5">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <a href="{{ route('groups.index') }}" class="btn waves-effect red waves-light right m-r-10">Back to
