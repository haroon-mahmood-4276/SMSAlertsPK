            ...
            <div class="card-content">
                <div class="row">
                    <div class="col l12 m12 s12">
                        ...
                        @endif
                        <form action="{{ route('r.delete-selected-subjects') }}" method="POST">
                            @csrf
                            @method('DELETE')
                                    ...
                                    <div class="d-flex">
                                        <div class="mr-auto">
                                            <div class="form-group">
                                                <a href="{{ route('subjects.create') }}" class="btn btn-small"><i
                                                        class="icon wb-plus waves-effect waves-light"
                                                        aria-hidden="true"></i>Add New Subject</a>
                                                </a>
                                                <button type="submit"
                    ...
                    <div class="col s6 m6 l6">
                        <p class="m-t-10 multidelchk">
                            <label>
                                <input type="checkbox" class="chkbox filled-in" name="subject_ids[]"
                                    value="{{ $Subject->id }}" />
                                <span>&nbsp;</span>
                            </label>
                        </p>
