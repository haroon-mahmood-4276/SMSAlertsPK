        ...
        <div class="col l12 m12 s12">
            <div class="card">
                <div class="card-content">
                    ...
                    <form class="formValidate" id="formValidate" action="{{route('data.store')}}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m6 l6">
                                ...
                                <select class="form-select" name="section" id="section">
                                    ...
                                    <option value="{{$Section->id}}"
                                        {{ ($Section->id == old('section') ? 'selected':'') }}>{{$Section->name}}
                                    </option>
                                    @endforeach
                                </select>
                                @error('section')
                            ...
                            <div class="input-field col s12 m6 l6">
                                ...
                                <input id="parent_mobile_1" name="parent_mobile_1" type="text"
                                    class="@error('parent_mobile_1') error @enderror" value="{{old('parent_mobile_1')}}"
                            ...
                            <div class="input-field col s12 m6 l6">
                                ...
                                <input id="parent_mobile_2" name="parent_mobile_2" type="text"
                                    class="@error('parent_mobile_2') error @enderror" value="{{old('parent_mobile_2')}}"
                                    placeholder="923001234567">
