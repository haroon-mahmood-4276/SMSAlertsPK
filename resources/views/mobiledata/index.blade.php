                        ...
                        <table id="demo-foo-pagination" class="table m-b-0 toggle-arrow-tiny" data-page-size="10">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$MobileData->roll_no}}</td>
                                    <td>{{$MobileData->student_first_name}} {{$MobileData->student_last_name}}</td>
                                    <td>{{$MobileData->student_mobile_1}}</td>
                                    <td>{{$MobileData->parent_first_name}} {{$MobileData->parent_last_name}}</td>
                                    ...
                                    <td>
                                        <a href="{{route("data.edit", ['data'=>$MobileData->id])}}" type="button"
