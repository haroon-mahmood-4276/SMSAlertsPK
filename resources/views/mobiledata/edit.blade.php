...
<div class="container mb-5 card">
    ...
    <form action="{{route('mobiledata.update', ['group' => $Group->id])}}" method="POST">
        @csrf
        @method('PATCH')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="first_name" class="form-control @error('first_name') is-invalid @enderror"
                id="first_name" value="{{$MobileData->first_name}}" placeholder="Frsit Name">
            @error('first_name')
            <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
        <div class="mb-3">
            ...
            <input type="text" name="last_name" class="form-control @error('first_name') is-invalid @enderror"
                id="last_name" value="{{$MobileData->last_name}}" placeholder="Last Name">
            @error('last_name')
            <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
        <div class="mb-3">
            ...
            <input type="text" name="parent_mobile_1" class="form-control" id="parent_mobile_1"
        ...
        <div class="mb-3">
            ...
            <input type="text" name="student_mobile_1" class="form-control" id="student_mobile_1"
                value="{{$MobileData->student_mobile_1}}" placeholder="923001234567">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="student_mobile_2" class="form-control" id="student_mobile_2"
                value="{{$MobileData->student_mobile_2}}" placeholder="923001234567">
