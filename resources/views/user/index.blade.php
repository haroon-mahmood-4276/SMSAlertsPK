                            ...
                            <div class="col s12 l12">
                                ...
                                <div class="right">
                                    <form action="{{ route('users.index') }}">
                                        <div class="input-field inline">
                                            <select class="form-select inline" name="user_type" onchange="this.form.submit()">
                        ...
                        <table id="demo-foo-addrow2" class="table m-b-0 toggle-arrow-tiny" data-page-size="10">
                                ...
                                <div class="d-flex">
                                    <div class="mr-auto">
                                        <div class="form-group">
                                            <a href="{{ route('users.create') }}" class="btn btn-small"><i class="icon wb-plus waves-effect waves-light" aria-hidden="true"></i>
                                                Add New User
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('data.edit', ['data' => $User->id]) }}" type="button" class="btn btn-small blue m-5 left waves-effect waves-light"><i class="material-icons">edit</i></a>
                                        <form method="POST" action="{{ route('data.destroy', ['data' => $User->id]) }}">
                                            @csrf
                                            @method('DELETE')
