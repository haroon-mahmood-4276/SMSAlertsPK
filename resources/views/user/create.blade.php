                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6 l6">
                                    <select class="form-select" name="company_nature" id="company_nature">
                                        ...
                                        <option value="B" {{ old('company_nature') == 'B' ? 'selected' : '' }}>Business
                                            User
                                        </option>
                                        <option value="S" {{ old('company_nature') == 'S' ? 'selected' : '' }}>School
                                            User
                                        </option>
                                        <option value="HE" {{ old('company_nature') == 'HE' ? 'selected' : '' }}>Higher
                                            Education User
                                        </option>
                                    </select>
