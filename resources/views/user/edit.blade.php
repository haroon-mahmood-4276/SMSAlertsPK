    ...
    <form action="{{route('users.update', ['user' => $User->id])}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="password" name="password" class="form-control" id="password"
                placeholder="Leave blank to use previous password">
            @error('password')
            <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
        <div class="mb-3">
            ...
            <input type="text" name="company_name" class="form-control" id="company_name"
                value="{{$User->company_name}}" placeholder="abc@example.com">
            @error('company_name')
            <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
        <div class="mb-3">
            ...
            <input type="text" name="company_mask_id" class="form-control" id="company_mask_id"
                value="{{$User->company_mask_id}}" placeholder="Company Mask ID">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="company_nature" id="company_nature">
                <option value="" {{ (Input::old("title") == '' ? "selected":"") }}>Select</option>
                <option value="B" {{ ($User->company_mask_id == 'B' ? "selected":"") }}>Business</option>
                <option value="S" {{ ($User->company_mask_id == 'S' ? "selected":"") }}>School</option>
            </select>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="company_email" class="form-control" id="company_email"
                value="{{$User->company_email}}" placeholder="abc@example.com">
            @error('company_email')
            <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
        <div class="mb-3">
            ...
            <input type="text" name="mobile_1" class="form-control" id="mobile_1" value="{{$User->mobile_1}}"
        ...
        <div class="mb-3">
            ...
            <input type="number" name="mobile_2" class="form-control" id="mobile_2" value="{{$User->mobile_2}}"
                placeholder="923001234567">
            @error('mobile_2')
            <span class="text-danger">{{$message}}</span>
            @enderror
        ...
        <div class="mb-3">
            ...
            <input type="number" name="no_of_sms" class="form-control" id="no_of_sms" value="{{$User->no_of_sms}}">
            @error('no_of_sms')
            <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
